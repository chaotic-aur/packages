...
_pkgname="mystiq"
pkgname="$_pkgname"
pkgver=25.04.17+1513
pkgrel=1
pkgdesc="FFmpeg GUI front-end based on Qt6"
...
_pkgsrc="MystiQ-mystiq-${pkgver//+/-}-x86_64"
_pkgext="tar.gz"
source=("$url/archive/refs/tags/mystiq-${pkgver//+/-}-x86_64.$_pkgext")
sha256sums=('4f3aa80f84d038abaa9825cde7996f6281b34bc60dada2c59e3cf51b2399b907')
...
package() {
  ...
  install -Dm644 /dev/stdin "$pkgdir/usr/share/kio/servicemenus/$_pkgname.desktop" << END
[Desktop Entry]
Type=Service
